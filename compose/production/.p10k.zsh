# Generated by Powerlevel10k configuration wizard on 2019-12-09 at 11:10 EET.
...
# angled separators, sharp heads, blurred tails, 2 lines, dotted, full frame, darkest,
...
() {
  ...
  # local ip
  function prompt_ip() {
    p10k segment -b 23 -f 15 -i '⭐' -t `zsh_ip`
  }
